...
public class StringMinipulationDemo3 {
	...
	public static void main(String[] args) {
		...
		String sentence="Each day has a promise ti brighten up the day, \nbut first you must allow the sun to come your way";
		
		System.out.println(sentence);
		
		System.out.println("^^^^^^^^^^^^^^^^^^^");
		/*
		 * Thid method appends one String to the end of another.
		...
		System.out.println(str3.concat(str4).concat(" "+str5+3));
		...
		/*This method returns the chracter located at the String's specified index.
		...
		System.out.println(str8.indexOf('y',5));
