...
public class Task {
	public static void main(String[] args) {
		 ...
		 * type of variables to store students city, state,phone number and grade. And print those updated * values. */
		...
		//String studentCity="Washington DC";
		// we do not need to declare
		//variable again
